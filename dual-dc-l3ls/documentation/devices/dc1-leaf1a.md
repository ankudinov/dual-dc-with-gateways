...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | C::dc1-spine1_Ethernet1 | routed | - | 10.255.255.1/31 | default | 1500 | False | - | - |
| Ethernet2 | C::dc1-spine2_Ethernet1 | routed | - | 10.255.255.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description C::dc1-spine1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description C::dc1-spine2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description C::MLAG_dc1-leaf1b_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description C::MLAG_dc1-leaf1b_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
...
interface Port-Channel3
   description C::MLAG_dc1-leaf1b_Po3
   no shutdown
   switchport
