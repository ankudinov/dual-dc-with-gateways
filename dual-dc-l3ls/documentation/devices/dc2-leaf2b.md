...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 172.16.1.114/24 | 172.16.1.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | C::MLAG_dc2-leaf2a_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | C::MLAG_dc2-leaf2a_Ethernet4 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet5 | M::dc2-leaf2-server1_PCI2 | *trunk | *11-12,21-22 | *4092 | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | C::dc2-spine1_Ethernet4 | routed | - | 10.255.255.117/31 | default | 1500 | False | - | - |
| Ethernet2 | C::dc2-spine2_Ethernet4 | routed | - | 10.255.255.119/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description C::dc2-spine1_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description C::dc2-spine2_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description C::MLAG_dc2-leaf2a_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description C::MLAG_dc2-leaf2a_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
   description M::dc2-leaf2-server1_PCI2
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | C::MLAG_dc2-leaf2a_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel5 | M::dc2-leaf2-server1 | switched | trunk | 11-12,21-22 | 4092 | - | - | - | 5 | - |
...
interface Port-Channel3
   description C::MLAG_dc2-leaf2a_Po3
   no shutdown
   switchport
...
interface Port-Channel5
   description M::dc2-leaf2-server1
   no shutdown
   switchport
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.128.16:10010 | 10010:10010<br>remote 10010:10010 | - | - | learned |
