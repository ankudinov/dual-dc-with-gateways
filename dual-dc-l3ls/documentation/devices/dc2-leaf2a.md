...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 172.16.1.113/24 | 172.16.1.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | C::MLAG_dc2-leaf2b_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | C::MLAG_dc2-leaf2b_Ethernet4 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet5 | M::dc2-leaf2-server1_PCI1 | *trunk | *11-12,21-22 | *4092 | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | C::dc2-spine1_Ethernet3 | routed | - | 10.255.255.113/31 | default | 1500 | False | - | - |
| Ethernet2 | C::dc2-spine2_Ethernet3 | routed | - | 10.255.255.115/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description C::dc2-spine1_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description C::dc2-spine2_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description C::MLAG_dc2-leaf2b_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description C::MLAG_dc2-leaf2b_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
   description M::dc2-leaf2-server1_PCI1
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | C::MLAG_dc2-leaf2b_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description C::MLAG_dc2-leaf2b_Po3
   no shutdown
   switchport
