...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | C::dc1-leaf1a_Ethernet1 | routed | - | 10.255.255.0/31 | default | 1500 | False | - | - |
| Ethernet2 | C::dc1-leaf1b_Ethernet1 | routed | - | 10.255.255.4/31 | default | 1500 | False | - | - |
| Ethernet3 | C::dc1-leaf2a_Ethernet1 | routed | - | 10.255.255.8/31 | default | 1500 | False | - | - |
| Ethernet4 | C::dc1-leaf2b_Ethernet1 | routed | - | 10.255.255.12/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description C::dc1-leaf1a_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description C::dc1-leaf1b_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description C::dc1-leaf2a_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description C::dc1-leaf2b_Ethernet1
   no shutdown
   mtu 1500
   no switchport
