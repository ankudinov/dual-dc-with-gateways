...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | C::dc1-spine1_Ethernet3 | routed | - | 10.255.255.9/31 | default | 1500 | False | - | - |
| Ethernet2 | C::dc1-spine2_Ethernet3 | routed | - | 10.255.255.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description C::dc1-spine1_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description C::dc1-spine2_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | C::MLAG_dc1-leaf2b_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description C::MLAG_dc1-leaf2b_Po3
   no shutdown
   switchport
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.0.5:10010 | 10010:10010<br>remote 10010:10010 | - | - | learned |
...
router bgp 65102
   ...
   vlan 10
      rd 10.255.0.5:10010
      rd evpn domain remote 10.255.0.5:10010
